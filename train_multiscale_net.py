...
def get_AFD(input_height=256, input_width=256, nClasses=1, n_filters=16, dropout=0.5, batchnorm=True, n_channels=1, dilation_rate = 1):
...
rlr = ReduceLROnPlateau(monitor='val_loss',
                        patience=12, #early stopping 의 절반
                        mode = 'max',
                        verbose= 1,
