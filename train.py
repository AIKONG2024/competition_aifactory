...
plt.plot(history.history['loss'], c = 'red', label = 'loss', marker = '.' )
plt.plot(history.history['val_loss'], c = 'green', label = 'val_loss', marker = '.' )
plt.plot(history.history['val_accuracy'], c = 'pink', label = 'val_accuracy', marker = '.' )
plt.plot(history.history[dice_coef], c = 'brown', label = 'dice_coef', marker = '.' )
plt.plot(history.history[pixel_accuracy], c = 'blue', label = 'pixel_accuracy', marker = '.' )
